        ...
        <div class="quick-reply-items">
          <div v-for="item in quickReplyList" :key="item.id" class="quick-reply-item">
            <div class="item-content">
              ...
              <MaterialPreview v-else-if="item.type === 'image'" :videoW="150" :videoH="80" :url="item.content"></MaterialPreview>
              <MaterialPreview v-else-if="item.type === 'video'" :videoW="150" :videoH="80" mediaType="video" :url="item.content"></MaterialPreview>
